...
def ai_analysis(indices, commodities, kr_stocks):
    ...
    try:
        ...
        news_sections = []
        for stock_name, query in [("삼성전자", "삼성전자 주가 전망"), ("SK하이닉스", "SK하이닉스 주가 전망"), ("현대차", "현대차 주가 전망")]:
...
{{
  ...
  "comments": {{
    "삼성전자": "오늘 주가 흐름과 주목할 포인트를 구체적으로 (30~45자)",
    "SK하이닉스": "오늘 주가 흐름과 주목할 포인트를 구체적으로 (30~45자)",
    "현대차": "오늘 주가 흐름과 주목할 포인트를 구체적으로 (30~45자)"
  }}
}}
...
<style>
  * {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  .ai-disclaimer {{ font-size: 0.85rem; font-weight: 500; color: #fbbf24; background: #2d2410; border: 1px solid #5c4a16; border-radius: 8px; padding: 10px 16px; margin-bottom: 28px; display: flex; align-items: center; gap: 8px; }}
